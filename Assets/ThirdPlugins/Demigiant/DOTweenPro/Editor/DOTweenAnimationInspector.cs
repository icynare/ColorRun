...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        override public void OnInspectorGUI()
        {
            ...
            GUILayout.Label(_src.animationType.ToString() + (string.IsNullOrEmpty(_src.id) ? string.Empty : " [" + _src.id + "]"), EditorGUIUtils.sideLogoIconBoldLabelStyle);
            // Up-down buttons
...
//                _src.animationType = (DOTweenAnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
                _src.isActive = EditorGUILayout.Toggle(new GUIContent(string.Empty, "If unchecked, this animation will not be created"), _src.isActive, GUILayout.Width(16));
        ...
        DOTweenAnimationType AnimationToDOTweenAnimationType(string animation)
        {
            ...
            animation = animation.Replace("/", string.Empty);
        ...
        void GUIEndValueV3(bool optionalTransform = false)
        {
            ...
            if (_src.useTargetAsV3) {
                ...
                _src.endValueV3 = EditorGUILayout.Vector3Field(string.Empty, _src.endValueV3, GUILayout.Height(16));
            }
        ...
        void GUIEndValueV2()
        {
            GUILayout.BeginHorizontal();
            GUIToFromButton();
            _src.endValueV2 = EditorGUILayout.Vector2Field(string.Empty, _src.endValueV2, GUILayout.Height(16));
            GUILayout.EndHorizontal();
        }
